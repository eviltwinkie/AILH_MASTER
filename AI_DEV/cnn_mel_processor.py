from UTILITIES.old_config import SAMPLE_RATE, CNN_BATCH_SIZE, MAX_THREAD_WORKERS, N_FFT, HOP_LENGTH, N_MELS, LONG_TERM_SEC, SHORT_TERM_SEC, STRIDE_SEC, CACHE_DIR, MAX_THREAD_WORKERS, TMPDIR
