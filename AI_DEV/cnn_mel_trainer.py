...
from UTILITIES.old_config import BASE_DIR, MIN_BATCH_SIZE, MAX_BATCH_SIZE, HOP_LENGTH, LONG_TERM_SEC, SHORT_TERM_SEC, STRIDE_SEC, N_MELS, N_FFT, SAMPLE_RATE, MAX_THREAD_WORKERS, CPU_COUNT
